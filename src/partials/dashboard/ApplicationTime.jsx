...
import useApplicationStats from "../../hooks/dashboard/useApplicationStats";

// Import utilities
import { tailwindConfig, hexToRGB } from "../../utils/Utils";

function ApplicationTime() {
  const { labels, values } = useApplicationStats();
  const chartData = {
    labels,
    datasets: [
      // Indigo line
  ...
  return (
    <div className="flex flex-col col-span-12 xl:col-span-8 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
